  ...
  const projects = [
    {
      ...
      description: 
        "Real-time stock monitoring dashboard with live price tracking, interactive charts, and customizable watchlists",
      link: "https://stock-monitor-app-two.vercel.app",
      tags: ["Typescript", "React", "Tailwind", "Next.js", "Vercel", "API Integration"],
      ...
      <section id="projects" className="relative py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl sm:text-6xl font-black mt-6 mb-6">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {projects.map((project, index) => (
              ...
              >
                {/* Card glow effect */}
                <div
                  className={`absolute -inset-0.5 bg-gradient-to-r ${project.gradient} rounded-2xl blur opacity-30 group-hover:opacity-100 transition duration-1000 group-hover:duration-200`}
                ></div>

                {/* Card content */}
                <div className="relative bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 h-full group-hover:border-white/30 transition-all duration-300 flex flex-col">
                {/* Emoji icon */}
                  ...
                  <div className="relative z-10 flex flex-col flex-1">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-2xl font-bold mb-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:from-blue-400 group-hover:to-purple-400 transition-all">
                          {project.title}
                        </h3>
                        <div
                          className={`h-1 w-16 bg-gradient-to-r ${project.gradient} rounded-full group-hover:w-24 transition-all duration-300`}
                        ></div>
                      </div>
                      <div className="p-2 bg-white/5 rounded-xl group-hover:bg-white/10 transition-colors shrink-0 ml-2">
                        <svg
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="text-xs font-medium px-3 py-1.5 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 hover:bg-white/10 hover:border-white/20 transition-colors"
                        >
                          {tag}
                        </span>
                      ))}
